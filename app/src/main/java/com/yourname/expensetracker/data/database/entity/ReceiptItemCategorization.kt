...
@Entity(
    ...
    foreignKeys = [
        // DB-8: CASCADE on ReceiptItemCategorization.receiptId → ScannedReceipt(id)
        // Safe: Categorizations are child data of a receipt; orphaned categorizations are useless.
        ForeignKey(
