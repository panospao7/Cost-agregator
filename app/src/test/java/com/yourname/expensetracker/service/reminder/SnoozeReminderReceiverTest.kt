...
/**
 * PR12E — SnoozeReminderReceiver now enqueues a [SnoozeReminderActionWorker]
...
class SnoozeReminderReceiverTest {
    ...
    private fun buildReceiver(): SnoozeReminderReceiver {
        ...
        SnoozeReminderReceiver::class.java.getDeclaredField("workManager").apply {
            isAccessible = true
    ...
    fun `receiver does NOT call coordinator directly`() = runBlocking {
        ...
        io.mockk.coVerify(exactly = 0) { coordinator.snoozeReminderDelivery(any(), any()) }
    }
