...
| P9-P1-11 | P1 | Privacy changes don't actively cancel workers | Bug | `applyPrivacyChange()` in `PrivacySettingsRepositoryImpl` now cancels affected workers on setting change | ✅ FIXED |
