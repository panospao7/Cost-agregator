...
> **Core engines stabilized (29 fixed with real code). Advanced engines (groups, tax, investment advanced features) are beta/contained — 41 items documented as TODO-only, 18 deferred, 20 deferred-design.**
