...
|------|---------------|-----------------|-----------------|
| **MIT-031** (State/Event atomicity) | ❌ TODO | ✅ NEAR-COMPLETE | ✅ **DONE** — PR22: 14 DomainTransactionRunner sites, provenance guard (6 entries), 0 manual contexts, structured direct event guard, stale recovery transactional |
...
| **MIT-041** (Receipt/review atomicity) | ❌ TODO | ✅ NEAR-COMPLETE | ✅ **DONE** — PR22: Bank cancellation safe, non-cancellation safe, failure atomic with receipt event, 7 audit tests, terminal policy documented |
...
| **Bank statement compile** | ❌ FAIL (importRunId null) | ❌ FAIL | ✅ FIXED — importRunId non-null (PR19-1) |
