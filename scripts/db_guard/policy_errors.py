...
DB_V2_POLICY_FILE_UNREADABLE = "DB_V2_POLICY_FILE_UNREADABLE"
DB_V2_POLICY_OWNER_MISSING = "DB_V2_POLICY_OWNER_MISSING"
DB_V2_POLICY_OWNER_AMBIGUOUS = "DB_V2_POLICY_OWNER_AMBIGUOUS"
DB_V2_POLICY_CALLABLE_MISSING = "DB_V2_POLICY_CALLABLE_MISSING"
DB_V2_POLICY_CALLABLE_AMBIGUOUS = "DB_V2_POLICY_CALLABLE_AMBIGUOUS"
DB_V2_POLICY_KIND_UNSUPPORTED = "DB_V2_POLICY_KIND_UNSUPPORTED"
DB_V2_POLICY_PARSER_UNCERTAIN = "DB_V2_POLICY_PARSER_UNCERTAIN"
DB_V2_POLICY_BODY_UNSUPPORTED = "DB_V2_POLICY_BODY_UNSUPPORTED"
DB_V2_POLICY_DAO_ACCESSOR_UNRESOLVED = "DB_V2_POLICY_DAO_ACCESSOR_UNRESOLVED"
DB_V2_POLICY_DAO_FQCN_MISMATCH = "DB_V2_POLICY_DAO_FQCN_MISMATCH"
DB_V2_POLICY_MUTATION_NOT_FOUND = "DB_V2_POLICY_MUTATION_NOT_FOUND"
DB_V2_POLICY_UNLISTED_MUTATION = "DB_V2_POLICY_UNLISTED_MUTATION"
DB_V2_POLICY_DAO_AMBIGUOUS = "DB_V2_POLICY_DAO_AMBIGUOUS"
DB_V2_POLICY_BARRIER_METADATA_INCONSISTENT = "DB_V2_POLICY_BARRIER_METADATA_INCONSISTENT"
# GR-06 repair: distinct code for a v2 policy target whose every same-name
# declaration is retained under the parser's tolerant TYPE_UNRESOLVED status
# -- the callable exists but its own signature types cannot be resolved
# exactly.  Never reused for generic parser uncertainty.
DB_V2_POLICY_SIGNATURE_UNRESOLVED = "DB_V2_POLICY_SIGNATURE_UNRESOLVED"
