...
GUARD_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "known_good_state": {
        ...
        "description": "Known-good state scorecard (PR-GR-10e/10f) — "
                       ...
                       "migration fold truth 97/54/43, source-roots "
                       "meta-guard silent exit 0, candidate v2 "
                       "byte-reproducible with 471 entries (post-GR-14h "
                       "Pattern E removals, 2026-09-07; equal to the "
                       "active policy key set), structural "
